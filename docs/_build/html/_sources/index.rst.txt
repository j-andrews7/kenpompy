...
This a work in progress - currently all of the miscellaneous and summary page scraping modules are functional. :code:`Team` and :code:`Player` classes are planned, but they're more complicated.
